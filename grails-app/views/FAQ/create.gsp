...
<html>
	...
	<body>
		<a href="#create-FAQ" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
		...
		<jqvalui:renderValidationScript for="pac.FAQ" not="pulished" />
	</body>
</html>
