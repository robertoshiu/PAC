...
<html>
	...
	<body>
		<a href="#edit-news" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
		...
		<jqvalui:renderValidationScript for="pac.News" />
	</body>
</html>
