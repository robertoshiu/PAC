			...
			<table>
				...
				<g:each in="${userInstanceList}" status="i" var="userInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td><g:formatDate timeZone ="GMT+8" date="${userInstance.createDate}" /></td>
					
						<td><g:formatDate timeZone ="GMT+8" date="${userInstance.lastLogin}" /></td>
					
						<td><g:checkBox name="aBooleanValue" value="${userInstance.enabled}" disabled="true" /></td>
